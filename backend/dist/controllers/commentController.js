...
const postComment = async (req, res) => {
    ...
    try {
        ...
        // Insert bình luận
        const insertResult = await (0, db_1.query)(`INSERT INTO ticket_comments (ticket_id, user_id, content) 
       VALUES ($1, $2, $3) 
       RETURNING id, ticket_id, user_id, content, created_at`, [ticket_id, userId, content]);
...
const getTimeline = async (req, res) => {
    ...
    try {
        ...
        const timelineResult = await (0, db_1.query)(`SELECT 'comment' as type, c.id, u.username as user_name, u.role as user_role, c.content, c.created_at
